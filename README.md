...
- 📖 **教材选择**：按课组织（新概念英语第一册 72 课 + 第二册 96 课）
...
- **没有声音？** 先点一下页面任意位置再点发音按钮；检查手机音量。**微信内置浏览器不支持发音**，请在微信里点右上角「···」→「在浏览器中打开」，或直接用 Chrome / Safari / Edge 打开网址。
- **音色和电脑不一样？** 每台设备的系统音色都不同，到「设置 → 发音设置」里挑选本设备喜欢的音色即可。
...
- **课文内容说明**：课程内容由 AI 依据教材编写，个别词句可能与原书有细微出入；手边有教材的话建议对照校对。

## 版本

- v0.1.6 — 音色设置、一键安装、手机音频修复
- v0.2.0 — 新概念1 全部 72 课（奇数课）+ 新概念2 全部 96 课
